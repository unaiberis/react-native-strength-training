  ...
  return (
    <ErrorBoundary>
      <View className="flex-1 px-4 pt-4">
        ...
        {/* Quick actions */}
        <TouchableOpacity
          onPress={() => router.push("/(coach)/assigned-programs")}
          className="bg-card border border-border rounded-2xl p-4 mb-4 flex-row items-center justify-between"
          activeOpacity={0.7}
          accessibilityRole="button"
          accessibilityLabel="View assigned programs"
        >
          <View className="flex-row items-center gap-3">
            <View className="w-10 h-10 rounded-full bg-graphite items-center justify-center">
              <Ionicons name="clipboard-outline" size={20} color="#B9B9B6" />
            </View>
            <View>
              <Text className="text-surface-50 font-semibold text-base">
                View Assignments
